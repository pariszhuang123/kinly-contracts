...
# Contract - Kinly Marketing Surface Namespacing - v1.2
...
### Kinly navigation hub

`/kinly/overview`

This path is a supplementary Kinly navigation page.

It MUST:

- remain human-readable
- link to `/kinly/general`
- allow linking to Kinly-adjacent tools such as `/tools/qr`
- remain safe to open in any browser context
...
- `/kinly/overview` MUST remain a readable navigation page, not a redirect
...
This contract is active and supersedes `links_marketing_surface_namespacing_v1_1.md`.
