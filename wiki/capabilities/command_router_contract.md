# Capability: command_router_contract

- Canonical-Id: `command_router_contract`
- Latest doc: [Kinly Command Router Contract v1.1](../../contracts/api/kinly/command/command_router_contract_v1_1.md)
- Domain: [[../domains/command|command]]

## Versions

- `v1.1` `draft` [Kinly Command Router Contract v1.1](../../contracts/api/kinly/command/command_router_contract_v1_1.md)
