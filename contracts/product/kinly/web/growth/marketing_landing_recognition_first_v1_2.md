...
- Regional availability MUST reference the active region gating contract (`links_region_gate_v1_3.md`). Supported regions are currently **NZ**, **SG**, and **MY**; use that list verbatim.
