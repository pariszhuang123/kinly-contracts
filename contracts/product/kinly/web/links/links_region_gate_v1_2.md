...
# Contract - Region Gating & Interest Capture v1.2
...
|---------|----------------|
| `country_code in supported` | Supported |
| `country_code not in supported` | Unsupported |
...
- `user_agent`
- `intent_type` in { `preview`, `capability`, `join` }
